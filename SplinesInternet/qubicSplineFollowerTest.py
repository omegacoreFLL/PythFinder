...
import qubicSplineInternetTest
...
def get_forward_course(dl):
    ...
    cx, cy, cyaw, ck, s = qubicSplineInternetTest.calc_spline_course(
        ax, ay, ds=dl)
...
def get_switch_back_course(dl):
    ...
    cx2, cy2, cyaw2, ck2, s2 = qubicSplineInternetTest.calc_spline_course(
        ax, ay, ds=dl)
